...
pipwerks.SCORM.data.save = function(){
	...
	//console.log("If you see this, data should be saved to the LMS...<sigh>");
    var success = false,
		scorm = pipwerks.SCORM,
		trace = pipwerks.UTILS.trace,
		makeBoolean = pipwerks.UTILS.StringToBoolean,
    ...
    if(scorm.connection.isActive){
        ...
        if(API){
        	...
        	//console.log('Debug message: LMSCommit -> ' + API.LMSCommit(""));
        	//console.log('Type of LMSCommit is ' + typeof(API.LMSCommit("")));

          
			switch(scorm.version){
				case "1.2" : success = makeBoolean((API.LMSCommit("")).toString()); break;
				case "2004": success = makeBoolean((API.Commit("")).toString()); break;
			}
